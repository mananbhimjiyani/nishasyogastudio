...
class FeesApprovalPage extends StatefulWidget {
  const FeesApprovalPage({super.key});

  @override
  _FeesApprovalPageState createState() => _FeesApprovalPageState();
}

class _FeesApprovalPageState extends State<FeesApprovalPage> {
  ...
  Future<void> updateApprovalStatus(FeesCollection feesCollection) async {
    final url = Uri.parse(
  ...
  Future<void> fetchDataFromServer() async {
    final url = Uri.parse('https://app.nishasyoga.com/FeesCollection.php');
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    IconButton(
                                      onPressed: () {
                                        updateApprovalStatus(feesData[index]);
                                      },
                                      icon: const Icon(
                                        Icons.check,
                                        color: Colors.green,
